...
def generate_launch_description():
    ...
    launch_args = [
        DeclareLaunchArgument("dnn_example_config_file", default_value=TextSubstitution(text="config/yolov8workconfig.json")),
    ...
    qr_node = Node(
        ...
        output="screen",
        parameters=[{
            "image_topic": "/image_out",   # 实际图像话题
            "sign_topic": "/qr_direction"                    # 自定义发布话题
        }],
        arguments=['--ros-args', '--log-level', 'warn'],
    )
